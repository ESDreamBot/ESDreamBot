...
if (message.content === '=invite') {
      message.author.send('  https://discordapp.com/api/oauth2/authorize?client_id=546269855716737025&permissions=0&scope=bo   |  تفضل ربط البوت     ').catch(e => console.log(e.stack));
